...
class User {
    ...
    /**
     * Get the value of complemen
     */
    public function getComplemen()
    {
        return $this->complemen;
    }

    /**
     * Set the value of complemen
     */
    public function setComplemen($complemen): self
    {
        $this->complemen = $complemen;

        return $this;
    }

    /**
     * Get the value of neighborhoo
     */
    public function getNeighborhoo()
    {
        return $this->neighborhoo;
    }

    /**
     * Set the value of neighborhoo
     */
    public function setNeighborhoo($neighborhoo): self
    {
        $this->neighborhoo = $neighborhoo;
